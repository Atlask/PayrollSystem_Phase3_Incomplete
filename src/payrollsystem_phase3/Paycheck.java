...
public class Paycheck implements Comparable<Paycheck>
{
    ...
    public boolean equals(Object obj)
    {
        ...
        return  employeeID == paycheck.employeeID
                && periodBeginDate.equals(paycheck.periodBeginDate)
                && periodEndDate.equals(paycheck.periodEndDate);
    }
     ...
     * @return 0 if both objects have the same value for the periodBeginDate instance variable.
     * A positive number if the calling object has a greater value for the periodBeginDate instance variable.
     * A negative number if the calling object has a lesser value for the periodBeginDate instance variable.
     */
    @Override
    public int compareTo(Paycheck paycheck)
    {
        return this.periodBeginDate.compareTo(paycheck.periodBeginDate);
    }
}
